...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/stefanspringer1/SwiftWorkflow", from: "0.0.104"),
        .package(url: "https://github.com/stefanspringer1/SwiftWorkflowExampleData", from: "0.0.100"),
    ],
    targets: [
